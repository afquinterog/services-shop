<div class="responsive-container overflow-hidden relative">
    ...
    <form wire:submit.prevent="createOrder" class="grid grid-cols-1 gap-y-6 sm:grid-cols-1 sm:gap-x-8">
        <div>
            <label for="name" class="text-sm font-medium text-white">{{ __('Name') }}</label>
            <div class="mt-1 mb-4">
            ...
            <label for="phone" class="text-sm font-medium text-white">{{ __('Phone') }}</label>
            <div class="mt-1 mb-4">
            ...
            <label for="quantity" class="text-sm font-medium text-white">{{ __('Quantity') }}</label>
            <div class="mt-1 mb-4">
            ...
            <div class="mt-12 flex">
                ...
                <div>
                    <span wire:loading>{{ __('Sending the message ...') }}</span>
                    @if ($orderSent)
                        <span>{{ __('Order received, our team will reach to you soon.') }}</span>
                    @endif
                </div>
            </div>
        </div>
