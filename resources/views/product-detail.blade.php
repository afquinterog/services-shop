            ...
            <div
                ...
                <div class="lg:ml-12 xl:mr-64">
                    ...
                    <div class="flex flex-wrap items-center mt-8">
                        ...
                        <!-- Social links -->
                        {{--                        <div class="flex items-center space-x-4 mt-0 ml-12">--}}
                        {{--                            <div class="w-8 h-8 {{ $styles->getSocialNetworksCircleBackgroundColor() }} rounded-full flex justify-center items-center">--}}
                        {{--                                <a href="" class="hover:{{ $styles->getSocialNetworksCircleHoverColor() }}">--}}
                    ...
                    <div class="mt-12">
                        <button
                            ...
                            class="flex {{ $styles->getButtonBackgroundColor() }} text-white font-semibold px-4 py-4
                    ...
                    <div class="container mx-auto lg:px-64 rounded-lg overflow-y-auto">
                        <div class="{{ $styles->getModalBackgroundColor() }} rounded" @click.away="openModal = false">
                            ...
                            <div class="modal-body px-8 py-8">
                                <livewire:product-order-form :product="$product"/>
                            </div>
                        </div>
                    </div>
                </div>
